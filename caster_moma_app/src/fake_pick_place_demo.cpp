...
void openGripper(trajectory_msgs::JointTrajectory& posture) {
  ...
  posture.joint_names[0] = "j2s6s200_joint_finger_1";
  posture.joint_names[1] = "j2s6s200_joint_finger_2";
...
void place(moveit::planning_interface::MoveGroupInterface& group) {
  ...
  place_location[0].place_pose.pose.position.x = 0.85;
  place_location[0].place_pose.pose.position.y = 0.10;
  place_location[0].place_pose.pose.position.z = 0.60;
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface) {
  ...
  collision_objects[1].primitive_poses[0].position.x = 0.85;
  collision_objects[1].primitive_poses[0].position.y = 0.10;
  collision_objects[1].primitive_poses[0].position.z = 0.60;
